...
import com.binarywang.spring.starter.wxjava.cp.config.WxCpTpConfiguration;
 ...
 */
@Component
public class TpSuiteCreateAuthHandler extends AbstractTpHandler {
  ...
  public WxCpXmlOutMessage handle(WxCpTpXmlMessage wxMessage, Map<String, Object> context, WxCpTpService service,
    ...
    logger.info("收到创建授权事件，内容：" ,wxMessage.getAllFieldsMap());
